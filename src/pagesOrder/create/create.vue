...
const selectedAddress = computed(() => {
  //调试
  //console.log('Pinia中的选中地址：', addressStore.selectedAddress)
  //console.log('接口返回的地址列表：', orderPre.value?.userAddresses)
  //console.log('找到的默认地址：',orderPre.value?.userAddresses?.find((v) => v.isDefault === 1),)
  const res =
    addressStore.selectedAddress || orderPre.value?.userAddresses.find((v) => v.isDefault === 1)
  //console.log('最终选中的地址：', res)
  return res
})
// 提交订单
